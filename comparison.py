...
g=nx.barabasi_albert_graph(6001, 15)
ung=nx.Graph(g)
...
#strongly_connected_components_file= open("strongly_connected_components_barabasi","w")
#connected_map={}
...
g=nx.erdos_renyi_graph(6001, 0.0025, directed=True)
ung=nx.Graph(g)
